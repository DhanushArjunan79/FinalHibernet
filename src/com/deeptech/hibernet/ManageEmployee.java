...
public class ManageEmployee {
	...
	public static void main(String[] args) {
		...
		Integer emp1 = ME.addEmployee("Pavithra","K","Developer",79000);
		Integer emp2 = ME.addEmployee("Arjunan","A","Admin",35000);
		Integer emp3 = ME.addEmployee("Lakshmi","A","Developer",35000);
		Integer emp4 = ME.addEmployee("Jayasurya","AL","Exe",25000);
		Integer emp5 = ME.addEmployee("Dhanush","AL","Developer",79000);
		//ME.listEmployee();
